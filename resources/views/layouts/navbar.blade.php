...
<nav class="navbar navbar-expand-lg bg-white rounded shadow-sm">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="me-2">
                <button class="btn btn-sm btn-link" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
...
<div id="app">
@php
    $placeholder = session()->get('lang') === 'fr' ? 'Recherche' : 'Search';
@endphp

<search-canvas-component :placeholder="'{{ $placeholder }}'"></search-canvas-component>
